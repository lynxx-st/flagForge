            ...
            <div className="bg-white/80 dark:bg-white/[0.03] border border-white/60 dark:border-white/10 rounded-[2rem] p-6 transition-colors duration-300 shadow-xl">
              ...
              {latestRoom ? (
                <Link
                  ...
                  className="group block bg-white/70 dark:bg-white/[0.04] border border-white/60 dark:border-white/10 rounded-2xl p-5 hover:-translate-y-1 transition-all duration-300 cursor-pointer shadow-lg"
                >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2 text-sm text-red-500 dark:text-red-500 group-hover:text-red-600 dark:group-hover:text-red-500 transition-colors duration-300">
