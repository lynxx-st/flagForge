          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white/80 dark:bg-white/[0.03] border border-white/60 dark:border-white/10 rounded-[2rem] p-6 transition-colors duration-300 shadow-xl">
              ...
              {latestRoom ? (
                ...
                >
                  <div className="bg-white/70 dark:bg-white/[0.04] border border-white/60 dark:border-white/10 rounded-2xl p-5 group-hover:-translate-y-1 transition-all duration-300 shadow-lg h-full">
