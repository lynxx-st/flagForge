  ...
  const renderMarkdownContent = (content: string) => {
    ...
    return (
      <ReactMarkdown
        ...
        rehypePlugins={[
          rehypeHighlight, // 1. Run highlighting first
          [
            rehypeSanitize, // 2. Then sanitize the generated HTML
            {
              //
              //  ⛑️ IMPORTANT:
              //  This is a security-critical configuration for HTML sanitization.
              //  Modifying these rules can introduce XSS vulnerabilities.
              //
              //  This schema is based on rehype-sanitize's default but is explicitly
              //  defined here to prevent accidental loosening of security policies.
              //  It ensures that only safe, content-related HTML tags are allowed,
              //  stripping out potentially dangerous elements like <script>, <style>,
              //  and event handlers (e.g., onclick).
              //
              //  Allowed tags and attributes are restricted to common formatting
              //  and structural elements. Any changes should be reviewed by a
              ...
              schema: {
                ...
                attributes: {
                  ...
                  // Allow syntax highlighting classes generated by rehype-highlight
                  code: [
                    ...(rehypeSanitize.defaultSchema.attributes?.code || []),
                    "className",
                  ],
                  span: [
