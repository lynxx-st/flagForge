          ...
          <div className="mt-6 grid grid-cols-1 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)] gap-6">
            ...
            <div className="flex flex-col gap-6">
              ...
              >
                ...
                />
                <button
                  className={`w-full sm:w-[180px] flex items-center justify-center gap-2 border rounded-full px-4 py-2 text-white shadow-sm transition-colors duration-300 ${isSubmissionLocked
