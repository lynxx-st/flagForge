    ...
    >
      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-2 justify-between">
          <p className="text-sm sm:text-base font-medium text-gray-600 dark:text-gray-300 transition-colors duration-300">
      ...
      <p className="font-base font-[0.5rem] text-black dark:text-gray-200 line-clamp-2 transition-colors duration-300">
        {description}...{" "}
